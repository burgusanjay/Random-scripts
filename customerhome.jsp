...
<html>
	<head>
		...
		<title>Multi Banking |Customer Home</title>
	...
	<body>
			...
			<div id="main_container">
				...
				<div id="header">
					...
					<div id="menu">
						<ul>
							<li>
								<a class="current" href="customerhome.jsp"
		...
		<div class="center_content">
			...
			<center>
				<font color="#006400" size='2'> By using this module any customer can do some
					operations like create a new account, view the account information,
					Transfer amount from one account to other account and customer can
					also see the Transaction Reports. This module consists following
					functionalities.</font>
			</center>
			<br />
			<br>
			<br>
