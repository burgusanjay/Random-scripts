				...
				<div id="header">
					...
					<div id="menu">
						<ul>
							...
							<li>
								<a class="current" href="newacc.jsp" title="Create New Account">New Acc</a>
							</li>
							<li>
								<a href="#" title="Account Information">Acc Info</a>
							</li>
							<li>
								<a href="#" title="Amount Transfer">Transfer Amount</a>
							</li>
							<li>
								<a href="transactions.jsp" title="Transactions">Transactions</a>
							</li>
